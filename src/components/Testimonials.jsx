...
const testimonials = [
  ...
  },
  {
    ...
    age: '42 anos',
    stars: 5,
    result: 'Já indica pacientes',
    resultColor: 'bg-sage/10 text-sage-dark',
    text: 'Sou nutricionista e fui bem crítico antes de comprar. A profundidade técnica me surpreendeu — especialmente a lista de laboratórios. Já indico pra alguns pacientes.',
  ...
  },
  {
    ...
    result: 'Relendo já',
    resultColor: 'bg-gold/10 text-gold-dark',
    text: 'Comprei e chegou no meu email certinho. Ainda não apliquei nada mas já tô relendo pela segunda vez — muita coisa que eu não esperava encontrar aqui.',
    highlight: 'Agora só colocar em prática',
    colSpan: 'md:col-span-1'
  },
  {
    name: 'Marcio P.',
    age: '50 anos',
    stars: 5,
    result: '−7kg / mais disposição',
    resultColor: 'bg-sage/10 text-sage-dark',
    text: 'Fiquei meses na dúvida achando que era mais do mesmo. Comprei, li, apliquei. Três meses depois perdi 7kg e a disposição voltou. Devia ter comprado antes.',
